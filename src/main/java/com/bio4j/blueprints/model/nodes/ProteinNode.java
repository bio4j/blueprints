...
import com.bio4j.blueprints.model.nodes.citation.*;
...
import com.bio4j.blueprints.model.relationships.citation.book.BookProteinCitationRel;
...
import com.bio4j.blueprints.model.relationships.comment.DomainCommentRel;
import com.bio4j.blueprints.model.relationships.comment.FunctionCommentRel;
import com.bio4j.blueprints.model.relationships.comment.PathwayCommentRel;
import com.bio4j.blueprints.model.relationships.comment.SimilarityCommentRel;
import com.bio4j.blueprints.model.relationships.features.ActiveSiteFeatureRel;
import com.bio4j.blueprints.model.relationships.features.SignalPeptideFeatureRel;
import com.bio4j.blueprints.model.relationships.features.SpliceVariantFeatureRel;
import com.bio4j.blueprints.model.relationships.features.TransmembraneRegionFeatureRel;
import com.bio4j.blueprints.model.relationships.protein.*;
import com.bio4j.blueprints.model.relationships.uniref.UniRef100MemberRel;
import com.bio4j.blueprints.model.relationships.uniref.UniRef50MemberRel;
import com.bio4j.blueprints.model.relationships.uniref.UniRef90MemberRel;
...
public class ProteinNode extends Vertex implements Protein {
    ...
    public List<SignalPeptideFeature> getSignalPeptideFeature() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, SignalPeptideFeatureRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<SpliceVariantFeature> getSpliceVariantFeature() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, SpliceVariantFeatureRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<TransmembraneRegionFeature> getTransmembraneRegionFeature() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, TransmembraneRegionFeatureRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<ActiveSiteFeature> getActiveSiteFeature() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, ActiveSiteFeatureRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<FunctionComment> getFunctionComment() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, FunctionCommentRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<PathwayComment> getPathwayComment() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, PathwayCommentRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<DomainComment> getDomainComment() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, DomainCommentRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<SimilarityComment> getSimilarityComment() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, SimilarityCommentRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<ProteinProteinInteraction> getProteinOutgoingInteractions() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, ProteinProteinInteractionRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<ProteinProteinInteraction> getProteinIncomingInteractions() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.IN, ProteinProteinInteractionRel.NAME).iterator();
        while (iterator.hasNext()) {
            list.add(new ProteinProteinInteractionRel(iterator.next()));
        }
    ...
    public List<ProteinIsoformInteraction> getIsoformOutgoingInteractions() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.OUT, ProteinIsoformInteractionRel.NAME).iterator();
        while (iterator.hasNext()) {
    ...
    public List<ProteinIsoformInteraction> getIsoformIncomingInteractions() {
        ...
        Iterator<com.tinkerpop.blueprints.Edge> iterator = vertex.getEdges(Direction.IN, ProteinIsoformInteractionRel.NAME).iterator();
        while (iterator.hasNext()) {
            list.add(new ProteinIsoformInteractionRel(iterator.next()));
        }
